...
let getExcelValues readFromExcel = 
    ...
    let myTaskFunction x = getMyMap()   //legacy name, task not used in this app        
...
let createListInDirWithIncorrNoOfFiles low high = // = adresar, ktery kontroluji, tj. adresar s potencialnimi chybami, v teto app to jsou vsechny
